...
class _MainSecondState extends State<MainSecond> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    super.initState();
    listeningState();
    if (Platform.isIOS) initScanBeacon();
  }
  ...
  initScanBeacon() async {
    ...
    if (_streamRanging != null) {
      print("_streamRanging.isPaused = ${_streamRanging.isPaused}");
